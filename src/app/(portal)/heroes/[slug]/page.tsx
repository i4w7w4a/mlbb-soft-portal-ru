    ...
    <div className="mx-auto flex w-[min(100%-1.5rem,88rem)] flex-col gap-10">
      <Card className="relative overflow-hidden p-8 md:p-10">
        <div
          ...
          style={{
            background: `radial-gradient(circle at top right, ${hero.accent}45, transparent 30%), linear-gradient(180deg, rgba(5,9,18,0.2), rgba(5,9,18,0.94))`,
          }}
        />
        <div className="relative grid gap-8 xl:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="space-y-4 rounded-[32px] border border-white/10 bg-black/20 p-6">
            <p className="text-xs uppercase tracking-[0.24em] text-slate-500">Profile</p>
            <p className="text-sm leading-7 text-slate-200">{hero.signature}</p>
